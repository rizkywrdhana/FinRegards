...
public class EditRegardsActivity extends AppCompatActivity {
    ...
    TextView toWho, regard;
    ImageView photo;
    private Button simpanBtn, upBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_regards);
        ...
        regard = findViewById(R.id.regards_input);
        photo = findViewById(R.id.img_edit);
        ...
        simpanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String message = regard.getText().toString().trim();


                if (!validateInputs(name, message)) {
                    final ProgressDialog progressDialog = new ProgressDialog(EditRegardsActivity.this);
                    ...
                    file.put("message", regard.getText().toString());
                    db.collection("regards").document(id)
                            .set(file)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    progressDialog.dismiss();
                                    Toast.makeText(EditRegardsActivity.this, "Pesan Diperbaharui", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(EditRegardsActivity.this, RegardsActivity.class));
                                    finish();
                                }
                            })
            ...
            private boolean validateInputs(String name, String message) {
                ...
                if (message.isEmpty()) {
                    regard.setError("Regard must be filled!");
                    regard.requestFocus();
                    return true;
                }
                return false;
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EditRegardsActivity.this);
    ...
    private void uploadImageToFirebase(String namates, Uri contentUri) {
        ...
        Ref.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(EditRegardsActivity.this, "Upload Failled.", Toast.LENGTH_SHORT).show();
            }
        });
...
//        File storageDir = getExternalFilesDir(Environment.DIRECTORY_PICTURES);
    ...
    public void onBackPressed() {
        startActivity(new Intent(EditRegardsActivity.this, RegardsDetailActivity.class));
        finish();
    }
}